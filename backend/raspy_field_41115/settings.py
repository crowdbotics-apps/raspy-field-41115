"""
Django settings for raspy_field_41115 project.
...
ROOT_URLCONF = 'raspy_field_41115.urls'
...
WSGI_APPLICATION = 'raspy_field_41115.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_field_41115 API",
    "DESCRIPTION": "API documentation for raspy_field_41115 App",
    "VERSION": "v1",
}
